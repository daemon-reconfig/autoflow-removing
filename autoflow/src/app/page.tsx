          ...
          <ContainerScroll
            titleComponent ={
              <div className="flex items-center justify-center flex-col ">
                ...
                gap-4 hover:shadow-xl hover:shadow-neutral-500 duration-500 text-white"
                >
                  <span className="bg-clip-text text-transparent hover:text-white bg-gradient-to-r from-neutral-500
      ...
      <section className="mt-[-500px]">
        ...
        <div className="flex flex-wrap items-center justify-center flex-col md:flex-row gap-8 -mt-72">
            <CardContainer className="inter-var">
              <CardBody className="bg-gray-50 relative group/card dark:hover:shadow-2xl dark:hover:shadow-neutral-500/[0.1]
              dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-full md:!w-[350px] h-auto
              rounded-xl p-6 border">
                ...
                >
                  A Glimpse of what AutoFlow can do for you
                ...
                <div className="flex justify-between items-center mt-8">
                  ...
                  translateZ={20}
                  as="button"
                  className="px-4 py-2 rounded-xl text-xs dark:bg-white
                  dark:text-black text-white font-bold bg-black"
                  >
                    Get Started
                  </CardItem>
                </div>
            ...
            <CardContainer className="inter-var">
              <CardBody className="bg-gray-50 relative group/card dark:hover:shadow-2xl dark:hover:shadow-neutral-500/[0.1]
              dark:bg-black dark:border-white border-purple w-full md:!w-[350px] h-auto
              rounded-xl p-6 border">
                <CardItem 
                  translateZ="50"
                  className="text-xl font-bold text-neutral-600 dark:text-white"
